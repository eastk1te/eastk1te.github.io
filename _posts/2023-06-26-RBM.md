...
2. [Restricted Boltzmann Machine](https://www.edwith.org/deeplearningchoi/lecture/15304?isDesc=false)
3. ["A Fast Learning Algorithm for Deep Belief Nets", Geoffrey E. Hinton. (2006)"](https://blog.naver.com/esemoon/222977153973)
4. ["Restricted Boltzmann Machines
for Collaborative Filtering"](https://www.cs.toronto.edu/~amnih/papers/rbmcf.pdf)
1. [Deep Learning - RBM, DBN, CNN](http://sanghyukchun.github.io/75/)
